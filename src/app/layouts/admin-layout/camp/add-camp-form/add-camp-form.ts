...
@Component({
  ...
  templateUrl: "./add-camp-form.component.html",
  styleUrls: ["./add-camp-form.component.scss"],
})
export class AddCampFormComponent implements OnInit {
  campForm: FormGroup;
  editMode: boolean;
  countries: Country[];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddCampFormComponent>,
      ...
      if (this.data) {
        ...
        this.campService.editCamp(camp).subscribe(
          (data) => {
            ...
            this._snackBar.open("Campaign Details edited successfully", "X", {
        ...
        camp.campId =
          "shop&win-Camp" + Math.floor(new Date().getTime() + Math.random());
        ...
        this.campService.addCamp(camp).subscribe(
          (data) => {
            ...
            this._snackBar.open("Campaign Data added successfully", "X", {
              horizontalPosition: "center",
              verticalPosition: "top",
            });
          },
